...
export default function ViewProof({
  ...
  useEffect(() => {
    const updateOwnerObject = async () => {
      ...
      await getMetadata();
      tokenMetadata ? console.log("tokenMetadata2:", tokenMetadata): console.log('no imageurl yet')
    }
      ...
      <Row gutter={16}>
        <Col span={8}>
          <Card title="Owner Info:" bordered={false}>
            ...
            fontSize = {12}/>: "Set Proof"}
            <br></br>
            Proof Token Id: {proof_id}
