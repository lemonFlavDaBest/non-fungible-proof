...
`;
export function PrivacyPolicy ({ headingText = "Privacy Policy" }) {
  return (
        ...
        <ContentWithPaddingXl>
          ...
          <Text>
            ...
            <ul>
              ...
              <li>
                <strong>Website</strong> refers to Non-Fungible Proof, accessible from ____.
              </li>
              <li>
                <strong>Service</strong> refers to the Website.
              </li>
              <li>
                <strong>Country</strong> refers to: United State of America
              </li>
              <li>
                <p>
